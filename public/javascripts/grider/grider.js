    ...
    $.Grider = function(table, config) {
        ...
        */
        function setGrider(t) {
            ...
            if(config['delRow']) {
                var cssClass = $(table).find('tr.noedit:first th:last').attr("class") 
                $(table).find('tr.noedit:first').append("<th class='"+ cssClass +"'></th>")
                $(table).find('tr:not(.noedit)').each(function(index,elem){
                    $(elem).append('<td>' + config['delRowText'] + '</td>');
                });
...
Grider = {
    defaults : {
        ...
        delRowText: '<a href="#" class="delete">delete</a>',
        countRow: false,
        countRowText: 'Nº',
        countRowCol: 0,
        countRowAdd: false,
...
Grider = {
    defaults : {
        ...
        delRowText: '<a href="#" class="delete">borrar</a>',
        countRow: false,
        countRowText: 'Nº',
        countRowCol: 0,
        countRowAdd: false,
